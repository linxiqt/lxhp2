...
<body class="center-vh" style="background-image: url(../static/img/background.jpg); background-size: cover;">
    <div class="card card-shadowed p-5 mb-0 mr-2 ml-2">
        ...
        <p class="text-center text-muted mb-0">Copyright © 2025 <a target="_blank"
                href="http://www.bixiaguangnian.com">Linxiyy
            </a></p>
    </div>
