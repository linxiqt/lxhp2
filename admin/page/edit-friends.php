...
<div class="row">
    <div class="card">
        ...
        <div class="card-body">
            <form action="" method="post" name="edit-form" class="edit-friends-form edit-form">
                    ...
                    <div class="tab-pane fade show active" id="config"
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" id="des" name="des"
                                value="<?= $result["des"] ?>" placeholder="请输入">
                        </div>
                        <div class="mb-3">
                            <label for="ico" class="form-label">图标</label>
                            <input class="form-control" type="text" id="ico" name="ico"
                                value="<?= $result["ico"] ?>" placeholder="请输入">
                        </div>
                        <div class="mb-3">
...
<script>
    $('.edit-friends-form').on('submit', function(event) {
